-- Seed 10000 stress-test students for k6 load tests.
--
...
SELECT
  CONCAT('220', LPAD(nums.n, 5, '0')) AS student_no,
  '$2a$10$VA86e6YC19PMwyiIcyF/jueBSoZTzpx6Vtvcv4ZSiBbbj4HgJrN46' AS password_hash,
  CONCAT('StressStudent', LPAD(nums.n, 5, '0')) AS name,
  CONCAT('138', LPAD(nums.n, 8, '0')) AS phone,
  25 AS credit_limit,
  0 AS credit_used,
  1 AS status
FROM (
...
WHERE nums.n BETWEEN 1 AND 10000;
