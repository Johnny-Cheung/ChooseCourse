...
```powershell
docker compose --profile tools run --rm k6 run -e BASE_URL=http://backend:8080/api/v1 -e COURSE_ID=4 -e USERS=5000 -e STUDENT_PREFIX=2199 -e STUDENT_PAD_WIDTH=4 -e SPREAD_MS=1000 -e LOGIN_BATCH_SIZE=200 -e SETUP_TIMEOUT=25m -e NO_CONNECTION_REUSE=1 /work/tests/select_many_students.js
```
...
```powershell
  █ TOTAL RESULTS
    ...
    checks_total.......: 15000   262.10342/s
    ...
    HTTP
    http_req_duration..............: avg=45.4ms   min=637.2µs med=55.08ms  max=1.93s p(90)=65.85ms p(95)=74.63ms
      { expected_response:true }...: avg=45.4ms   min=637.2µs med=55.08ms  max=1.93s p(90)=65.85ms p(95)=74.63ms
    http_req_failed................: 0.00%  0 out of 10000
    http_reqs......................: 10000  174.735613/s

    EXECUTION
    iteration_duration.............: avg=669.63ms min=5.68ms  med=690.95ms max=2.35s p(90)=1.03s   p(95)=1.19s
    iterations.....................: 5000   87.367807/s
    vus............................: 185    min=0          max=4720
    vus_max........................: 5000   min=5000       max=5000

    NETWORK
    data_received..................: 7.5 MB 130 kB/s
    data_sent......................: 3.1 MB 54 kB/s
